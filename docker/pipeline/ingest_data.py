...
@click.option('--target-table', default='yellow_taxi_data', show_default=True, help='Target table in database')
@click.option('--chunksize', default=100000, show_default=True, type=int, help='Chunk size for pandas read_csv')
